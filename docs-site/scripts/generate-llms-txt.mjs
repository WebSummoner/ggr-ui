...
const SITE_URL = 'https://websummoner.riadvice.com/ggr-ui';
...
const lines = [
  '# Ggr UI docs',
  '',
  '> Guides and references for Ggr UI — a daemon that collects /status from',
  '> multiple WebSummoner instances into one API. Maintained by RIADVICE.',
  '',
];
